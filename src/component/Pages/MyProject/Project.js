                ...
                <div className="flex flex-col justify-between p-6 pt-1 space-y-4">
                    ...
                    <div className='flex justify-between'>
                        <a target='new tab' href={project?.live_link} >
                            <button className='btn bg-sky-500/100 btn-sm text-sm normal-case'>Live</button>
                        </a>
                        <a target='new tab' href={project?.live_link} >
                            <button className='btn bg-sky-500/100 btn-sm text-sm normal-case'>Client</button>
                        </a>
                        <a target='new tab' href={project?.live_link} >
                            <button className='btn bg-sky-500/100 btn-sm text-sm normal-case'>Server</button>
                        </a>
